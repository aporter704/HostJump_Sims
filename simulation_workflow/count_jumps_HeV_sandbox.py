...
database_name = "hev_sandbox.db"
dataset = "hev_common_test"
...
for i in range(10):
    ...
    prune_high_prop = select_tips_to_remove(tree = multitype_tree, location_to_retain = "2", location_to_remove = None, sampling_proportion = 0.5, opportunistic=False)
    ...
    prune_low_prop = select_tips_to_remove(tree = multitype_tree, location_to_retain = "2", location_to_remove = None, sampling_proportion =  0.05, opportunistic=False)
    ...
    prune_opportunistic_high = select_tips_to_remove(tree = multitype_tree, location_to_retain = "2", location_to_remove = None, sampling_proportion = 0.5, opportunistic=True, sampling_start_age = first_target_date)
    ...
    prune_opportunistic_low = select_tips_to_remove(tree = multitype_tree, location_to_retain = "2", location_to_remove = None, sampling_proportion = 0.05, opportunistic=True, sampling_start_age = first_target_date)
